...
COLUMN_NAME_MAPPINGS = {"LSOA code": "lsoa_code",
    ...
    'WIMD income deprivation count (0-4)': 'wimd_income_deprivation_count_0_to_4',
    ...
    'WIMD educaiton domain - percentage of key stage 4 leavers entering higher education': 'wimd_education_domain_key_stage_4_leavers_entering_higher_education_percentage',
    ...
    'WIMD access to services - average public return traveltime to a pharmacy (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_pharmacy_mins',
    'WIMD access to services - average public return traveltime to a food shop (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_food_shop_mins',
    'WIMD access to services - average public return traveltime to a GP surgery (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_gp_surgery_mins',
    'WIMD access to services - average public return traveltime to a post office (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_post_office_mins',
    'WIMD access to services - average public return traveltime to a primary school (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_primary_school_mins',
    'WIMD access to services - average public return traveltime to a public library (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_public_library_mins',
    'WIMD access to services - average public return traveltime to a sports facility (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_sports_facility_mins',
    'WIMD access to services - average public return traveltime to a secondary school (mins)': 'wimd_access_to_services_domain_average_public_return_travel_time_to_a_secondary_school_mins',
    'WIMD access to services - average private return traveltime to a pharmacy (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_pharmacy_mins',
    'WIMD access to services - average private return traveltime to a food shop (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_food_shop_mins',
    'WIMD access to services - average private return traveltime to a GP surgery (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_gp_surgery_mins',
    'WIMD access to services - average private return traveltime to a post office (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_post_office_mins',
    'WIMD access to services - average private return traveltime to a primary school (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_primary_school_mins',
    'WIMD access to services - average private return traveltime to a public library (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_public_library_mins',
    'WIMD access to services - average private return traveltime to a sports facility (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_sports_facility_mins',
    'WIMD access to services - average private return traveltime to a secondary school (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_secondary_school_mins',
    'WIMD access to services - average private return traveltime to a petrol station (mins)': 'wimd_access_to_services_domain_average_private_return_travel_time_to_a_petrol_station_mins',
    ...
    'wimd_physical_environment_domain_proximity_to_accessible_natural_green_space_score_percentage_of_households': 'wimd_physical_environment_domain_households_at_risk_of_flooding_score',
    ...
    'Change in birth rates from 2018 to 2020': 'change_birth_rates_18to20',
    'Change in birth rates from 2017 to 2020': 'change_birth_rates_17to20',
